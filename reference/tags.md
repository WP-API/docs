...
<div class="secondary">
### Example Request
`$ curl -X OPTIONS -i http://demo.wp-api.org/wp-json/wp/v2/tags`</div>
...
`GET /wp/v2/tags`
### Example Request
`$ curl http://demo.wp-api.org/wp-json/wp/v2/tags`</div>
</section><section class="route">
<div class="primary">
## Retrieve a Tag
### Arguments
...
`GET /wp/v2/tags/&lt;id&gt;`
### Example Request
`$ curl http://demo.wp-api.org/wp-json/wp/v2/tags/&lt;id&gt;`</div>
</section><section class="route">
<div class="primary">
## Create a Tag
### Arguments
...
### Example Request
`$ curl -X DELETE http://demo.wp-api.org/wp-json/wp/v2/tags/&lt;id&gt;`</div>
</section>
