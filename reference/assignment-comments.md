...
<section class="route">
	<div class="primary">
		<h2>Schema</h2>
<p>The schema defines all the fields that exist within a assignment comments record. Any response from these endpoints can be expected to contain the fields below unless the `_filter` query parameter is used or the schema field only appears in a specific context.</p>
...
<div><section class="route">
	<div class="primary">
		<h2>List Assignment Comments</h2>
		<p>Query this endpoint to retrieve a collection of assignment comments. The response you receive can be controlled and filtered using the URL query parameters below.</p>

		<h3>Definition</h3>

		<code>GET /buddyboss-app/learndash/v1/assignments/&lt;id&gt;/comments/&lt;assignment_id&gt;</code>

		<h3>Example Request</h3>

		<code>$ curl https://example.com/wp-json/buddyboss-app/learndash/v1/assignments/&lt;id&gt;/comments/&lt;assignment_id&gt;</code>
	</div>
	<div class="secondary">
			<h3>Arguments</h3>
...
<section class="route">
	<div class="primary">
		<h2>Create a Assignment Comments</h2>
			<h3>Arguments</h3>
	<table class="arguments">
					<tr>
				<td>
	...
	<div class="secondary">
		...
		<code>POST /buddyboss-app/learndash/v1/assignments/&lt;id&gt;/comments/&lt;assignment_id&gt;</code>
	</div>
</section>
<section class="route">
	<div class="primary">
		<h2>Retrieve a Assignment Comments</h2>

		<h3>Definition & Example Request</h3>

		<code>GET /buddyboss-app/learndash/v1/assignments/&lt;id&gt;/comments/&lt;assignment_id&gt;/&lt;comment_id&gt;</code>

		<p>Query this endpoint to retrieve a specific assignment comments record.</p>

		<code>$ curl https://example.com/wp-json/buddyboss-app/learndash/v1/assignments/&lt;id&gt;/comments/&lt;assignment_id&gt;/&lt;comment_id&gt;</code>
	</div>
	<div class="secondary">
			<h3>Arguments</h3>
	<table class="arguments">
...
<section class="route">
	<div class="primary">
		<h2>Update a Assignment Comments</h2>
			<h3>Arguments</h3>
	<table class="arguments">
					<tr>
				<td>
	...
	<div class="secondary">
		...
		<code>POST /buddyboss-app/learndash/v1/assignments/&lt;id&gt;/comments/&lt;assignment_id&gt;/&lt;comment_id&gt;</code>
...
<section class="route">
	<div class="primary">
		<h2>Delete a Assignment Comments</h2>
			<h3>Arguments</h3>
	<table class="arguments">
					<tr>
				<td>
	...
	<div class="secondary">
		...
		<code>DELETE /buddyboss-app/learndash/v1/assignments/&lt;id&gt;/comments/&lt;assignment_id&gt;/&lt;comment_id&gt;</code>

		<h3>Example Request</h3>

		<code>$ curl -X DELETE https://example.com/wp-json/buddyboss-app/learndash/v1/assignments/&lt;id&gt;/comments/&lt;assignment_id&gt;/&lt;comment_id&gt;</code>
	</div>
</section>
</div>
