...
The credentials can be passed along to REST API requests served over https:// using [Basic Auth with CURL](https://ec.haxx.se/http/auth.html) / [RFC 7617](https://tools.ietf.org/html/rfc7617).
