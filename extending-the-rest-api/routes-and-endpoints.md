...
<ul>
 	<li>The "route" is `wp/v2/posts/123` - The route doesn't include `wp-json` because <code class="highlighter-rouge">wp-json` is the base path for the API itself.</li>
...
<ul>
 	<li>`GET` should be used for retrieving data from the API.</li>
 	<li>`POST` should be used for creating new resources (i.e users, posts, taxonomies).</li>
 	<li>`PUT` should be used for updating resources.</li>
 	<li>`DELETE` should be used for deleting resources.</li>
 	<li>`OPTIONS` should be used to provide context about our resources.</li>
</ul>
